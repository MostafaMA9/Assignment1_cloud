...
rule1 = create_rule(ELBV2,listener['Listeners'][0]['ListenerArn'], 'path-pattern', '/*', 1, target_group1['TargetGroups'][0]['TargetGroupArn'])
rule2 = create_rule(ELBV2,listener['Listeners'][0]['ListenerArn'], 'path-pattern', '/*', 2, target_group2['TargetGroups'][0]['TargetGroupArn'])
print('Done')
